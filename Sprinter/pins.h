...
//x axis pins
    ...
    #if GEN6HBPMOD == 1
    #define SCL_REUSE       16    //need to set SCL to tristate Thav 20120102
    #define TEMP_1_PIN      0     //using unused ADC Thav 20120102
    #define HEATER_1_PIN    17    //using SDA Thav 20120102
